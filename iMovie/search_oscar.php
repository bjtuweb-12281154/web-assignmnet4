	...
	<div id = "header"></div>
		...
		<?php
			...
			{ 
				...
				{?>
					<strong style = "font-size:200%; font-family:Times NEw Roma"><?php echo $movie_oscar; ?></strong>
				<?php
				}
			 	$result = mysql_query("SELECT * FROM movie_info WHERE Oscar like '%$movie_oscar%'") or die(mysql_error());
			 	if(mysql_num_rows($result) == 0) echo "没有该奖项的影片";
