	...
	<div id = "header"></div>
		<?php
			...
			{ 
				...
				{?>
					<strong style = "font-size:150%; font-family:Times NEw Roma"><?php echo $movie_type; ?></strong>
				<?php
				}
			 	$result = mysql_query("SELECT * FROM movie_info WHERE m_style like '%$movie_type%'") or die(mysql_error());
			 	if(mysql_num_rows($result) == 0) echo "没有该类型的影片";
