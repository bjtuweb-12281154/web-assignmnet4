	...
	<div id = "header"></div>
		...
		<?php
			...
			{ 
				...
				{?>
					<strong style = "font-size:150%; font-family:Times NEw Roma"><?php echo $movie_age; ?></strong>
				<?php
				}
			 	$result = mysql_query("SELECT * FROM movie_info WHERE m_age= '$movie_age'") or die(mysql_error());
			 	if(mysql_num_rows($result) == 0) echo "在该年代没有相应影片";
